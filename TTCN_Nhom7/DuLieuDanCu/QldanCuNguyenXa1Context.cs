...
namespace TTCN_Nhom7.DuLieuDanCu;

public partial class QldanCuNguyenXa1Context : DbContext
{
    public QldanCuNguyenXa1Context()
    {
    }

    public QldanCuNguyenXa1Context(DbContextOptions<QldanCuNguyenXa1Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-HDT67J9;Initial Catalog=QLDanCuNguyenXa1;Integrated Security=True;Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<ChuHo>(entity =>
        {
            entity.HasKey(e => e.MaChuHo).HasName("PK__ChuHo__3585628216917089");
        ...
        {
            entity.HasKey(e => e.MaVung).HasName("PK__DiaChi__BF118FFBCACC84CA");

            entity.ToTable("DiaChi");

            entity.HasIndex(e => e.MaHoKhau, "UQ__DiaChi__C8B086937B0314DD").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaHoKhau).HasName("PK__HoKhau__C8B086922024410A");
        ...
        {
            entity.HasKey(e => e.MaNhanKhau).HasName("PK__NhanKhau__7EE100877AE9E071");
        ...
        {
            entity.HasKey(e => e.MaPhanAnh).HasName("PK__PhanAnh__0701D06F8792976F");
        ...
        {
            entity.HasKey(e => e.MaTaiKhoan).HasName("PK__TaiKhoan__AD7C652917F9DB27");
        ...
        {
            entity.HasKey(e => e.MaThongBao).HasName("PK__ThongBao__04DEB54EA117A5DA");
            ...
            entity.HasMany(d => d.MaTaiKhoans).WithMany(p => p.MaThongBaos)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("MaThongBao", "MaTaiKhoan").HasName("PK__ThongBao__8E09731CAA2512D8");
