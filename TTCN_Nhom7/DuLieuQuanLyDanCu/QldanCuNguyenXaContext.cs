...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.MaChuHo).HasName("PK__ChuHo__358562828ED53461");
        ...
        {
            entity.HasKey(e => e.MaVung).HasName("PK__DiaChi__BF118FFB05E9FEAC");

            entity.ToTable("DiaChi");

            entity.HasIndex(e => e.MaHoKhau, "UQ__DiaChi__C8B08693C48AACF0").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaHoKhau).HasName("PK__HoKhau__C8B08692A5AAEC08");
        ...
        {
            entity.HasKey(e => e.MaNhanKhau).HasName("PK__NhanKhau__7EE10087D5A17F24");
        ...
        {
            entity.HasKey(e => e.MaPhanAnh).HasName("PK__PhanAnh__0701D06F9C65973B");
        ...
        {
            entity.HasKey(e => e.MaTaiKhoan).HasName("PK__TaiKhoan__AD7C6529F87E83E8");
        ...
        {
            entity.HasKey(e => e.MaThongBao).HasName("PK__ThongBao__04DEB54EE279C867");
            ...
            entity.HasMany(d => d.MaTaiKhoans).WithMany(p => p.MaThongBaos)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("MaThongBao", "MaTaiKhoan").HasName("PK__ThongBao__8E09731CD85EDA8C");
