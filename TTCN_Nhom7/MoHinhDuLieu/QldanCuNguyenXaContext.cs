...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-F758C5U;Initial Catalog=QLDanCuNguyenXa;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<ChuHo>(entity =>
        {
            entity.HasKey(e => e.MaChuHo).HasName("PK__ChuHo__358562826374D5E0");
        ...
        {
            entity.HasKey(e => e.MaVung).HasName("PK__DiaChi__BF118FFB0A56CE12");

            entity.ToTable("DiaChi");

            entity.HasIndex(e => e.MaHoKhau, "UQ__DiaChi__C8B0869301F08F8E").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaHoKhau).HasName("PK__HoKhau__C8B0869299BE3B2A");
        ...
        {
            entity.HasKey(e => e.MaNhanKhau).HasName("PK__NhanKhau__7EE10087067FFF95");
            ...
            entity.HasOne(d => d.MaTaiKhoanNavigation).WithMany(p => p.NhanKhaus)
                .HasForeignKey(d => d.MaTaiKhoan)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__NhanKhau__MaTaiK__4316F928");
        });

        modelBuilder.Entity<PhanAnh>(entity =>
        {
            entity.HasKey(e => e.MaPhanAnh).HasName("PK__PhanAnh__0701D06FBF22C4E2");
        ...
        {
            entity.HasKey(e => e.MaTaiKhoan).HasName("PK__TaiKhoan__AD7C65298A700BF2");
        ...
        {
            entity.HasKey(e => e.MaThongBao).HasName("PK__ThongBao__04DEB54E1BA0C78A");
            ...
            entity.HasMany(d => d.MaTaiKhoans).WithMany(p => p.MaThongBaos)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("MaThongBao", "MaTaiKhoan").HasName("PK__ThongBao__8E09731C34431C78");
