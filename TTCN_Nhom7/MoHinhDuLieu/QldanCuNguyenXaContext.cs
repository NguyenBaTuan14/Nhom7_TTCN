...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.MaChuHo).HasName("PK__ChuHo__358562822F2B444F");
        ...
        {
            entity.HasKey(e => e.MaVung).HasName("PK__DiaChi__BF118FFB62B440E5");

            entity.ToTable("DiaChi");

            entity.HasIndex(e => e.MaHoKhau, "UQ__DiaChi__C8B08693C363F6F0").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaHoKhau).HasName("PK__HoKhau__C8B086929762425A");
        ...
        {
            entity.HasKey(e => e.MaNhanKhau).HasName("PK__NhanKhau__7EE100877083D26A");
        ...
        {
            entity.HasKey(e => e.MaPhanAnh).HasName("PK__PhanAnh__0701D06FF6D9D72B");
        ...
        {
            entity.HasKey(e => e.MaTaiKhoan).HasName("PK__TaiKhoan__AD7C652932479F75");
        ...
        {
            entity.HasKey(e => e.MaThongBao).HasName("PK__ThongBao__04DEB54E2128182D");
            ...
            entity.HasMany(d => d.MaTaiKhoans).WithMany(p => p.MaThongBaos)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("MaThongBao", "MaTaiKhoan").HasName("PK__ThongBao__8E09731CFEEFE55A");
