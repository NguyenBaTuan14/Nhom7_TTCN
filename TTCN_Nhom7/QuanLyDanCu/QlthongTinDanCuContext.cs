...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=ADMIN\\MAY1;Initial Catalog=QLThongTinDanCu;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<ChuHo>(entity =>
        {
            entity.HasKey(e => e.MaChuHo).HasName("PK__ChuHo__358562821D0D8841");
        ...
        {
            entity.HasKey(e => e.MaVung).HasName("PK__DiaChi__BF118FFBEE3DAF39");
        ...
        {
            entity.HasKey(e => e.MaHoKhau).HasName("PK__HoKhau__C8B086925ADDFFD6");
        ...
        {
            entity.HasKey(e => e.MaCauHoi).HasName("PK__HoiDap__1937D77B403B02F7");
        ...
        {
            entity.HasKey(e => e.MaNhanKhau).HasName("PK__NhanKhau__7EE10087738FBB88");
        ...
        {
            entity.HasKey(e => e.MaTaiKhoan).HasName("PK__TaiKhoan__AD7C6529E527E800");
        ...
        {
            entity.HasKey(e => e.MaThongBao).HasName("PK__ThongBao__04DEB54EF66F2DC4");
